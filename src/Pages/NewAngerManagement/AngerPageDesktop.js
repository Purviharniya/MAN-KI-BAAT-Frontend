                                                ...
                                                <div className="card-text text-left">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-12">
                                                            <a href="/" className="btn btn-block anger-btn-one d-xs-block">VIEW MORE</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div className="card anger-card-one">
                                    ...
                                    <div className="row mt-3">
                                        <div className="col-12 col-md-7 offset-md-5 ">
                                            <a href="/" className="btn anger-btn-one btn-block d-xs-block">VIEW MORE</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-7">
                                <div className="card-body">
                                    <h6 className="card-title res">MOTIVATIONAL POSTS</h6><br/>
                                        <div className="row">
                                            <div className="col-12 ">
                                                <a href="/" className="btn btn-block anger-btn-two">VIEW</a>
                                            </div>
                                        </div>
                                </div>
                            </div>
                        ...
                        <div className="row no-gutters">
                            ...
                            <div className="col-7">
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        <div className="col-12 ">
                                            <a href="/" className="btn btn-block anger-btn-two">TEST</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="row no-gutters">
                            ...
                            <div className="col-7">
                                <div className="card-body">
                                    ...
                                    <div className="row">
                                        <div className="col-12 ">
                                                <a href="/" className="btn btn-block anger-btn-two" style={{marginBottom:'0'}}>CONTACT</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
